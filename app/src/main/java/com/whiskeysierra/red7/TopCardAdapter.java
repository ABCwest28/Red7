...
public class TopCardAdapter extends RecyclerView.Adapter<TopCardAdapter.ViewHolder> {
    private ArrayList<Card> cards;
    private Context context;
    private int itemWidth, itemHeight;

    public TopCardAdapter(Context context, ArrayList<Card> cards, int itemWidth, int itemHeight) {
